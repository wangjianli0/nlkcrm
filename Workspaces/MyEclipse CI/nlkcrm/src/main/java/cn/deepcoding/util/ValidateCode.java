...
//	 * 
//	 */
//	private static final long serialVersionUID = 8927711736902896890L;
//
//	private int width = 80;// 验证码宽度80
//
//	private int height = 26; // 验证码高度26
//
//	private int codeCount = 4; // 验证码个数
//
//	private int x = 0;
//
//	private int fontHeight=80; // 字体高度
//
//	private int codeY;
//
//	/**
...
//		session.setAttribute(SessionUtils.RANDOMCODEKEY, randomCode.toString());
//		//禁止图像缓存
